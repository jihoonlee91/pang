...
The service worker is registered only in production. Deploy smoke tests should confirm `index.html`, the JavaScript/CSS bundles, manifest, icon, and `sw.js` are all served below `/PANG-23020975/`.
